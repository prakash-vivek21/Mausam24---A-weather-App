      ...
      if (props.loaded) {
        try {
          ...
          const response = await fetch(
            `https://api.openweathermap.org/data/2.5/weather?lat=${props.latitude}&lon=${props.longitude}&units=metric&appid=${apiKey}`
          );
            ...
            <div class="col-md-8">
              <div className="card-body">
                <h1
                  ...
                  style={{ fontSize: "40px", color: "red" ,width:"250px"}}
                >
